...
export class Instagram implements SocialPlatform {
  ...
  async exchangeCodeForToken(
    ...
    if (!this.clientId || !this.clientSecret || !this.redirectUri) {
      throw new Error(
        "Instagram OAuth requires clientId, clientSecret, and redirectUri",
      );
    }
  ...
  async post(content: PostContent): Promise<PostResult> {
    if (!this.accessToken || !this.accountId) {
      return {
        ...
        success: false,
        error:
          "Instagram posting requires accessToken and accountId. Authenticate first.",
      };
    }
  ...
  async postStory(
    ...
    if (!mediaUrl.startsWith("http")) {
      return {
        success: false,
        error: "Instagram requires a public URL for media.",
      };
    }
    ...
    try {
      ...
      if (
        ...
        return {
          success: false,
          error:
            "Instagram API does not currently support media deletion. Please delete manually through the Instagram app.",
        };
      }
      return {
        success: false,
